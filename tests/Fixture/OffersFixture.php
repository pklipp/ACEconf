...
class OffersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'vimeo' => ['type' => 'string', 'length' => 64, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'sponsor_id' => ['type' => 'integer', 'length' => 10, 'unsigned' => true, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'vimeo' => 'Lorem ipsum dolor sit amet',
            'sponsor_id' => 1,
            'edition_id' => 1
        ],
    ];
